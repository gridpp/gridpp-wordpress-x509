<?php
class GridppWordpressX509OptionsPage {
	var $plugin;
	var $group;
	var $page;
	var $options;
	...
	function GridppWordpressX509OptionsPage($plugin, $group, $page, $options, $title = 'GridPP Wordpress X.509') {
		$this->plugin = $plugin;
		$this->group = $group;
		$this->page = $page;
...
?>
Should the plugin fallback to WordPress authentication if none is found from the client?
<?php
